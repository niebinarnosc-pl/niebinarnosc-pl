...
export default function Poradnik({data}) {
    return <Page className={"poradnik"} heading={"Poradnik"} subheading={"Pomyłki się zdarzają i nie ma w nich nic złego. O ile ktoś nie misgenderuje lub deadname’uje nas z premedytacją, wszystko jest w porządku. Jeśli nie chcesz być osobą enbyfobiczną, przyswój sobie poniższe zasady."}>
