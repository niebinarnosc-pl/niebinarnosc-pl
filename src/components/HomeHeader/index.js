...
export default function HomeHeader() {
  ...
  return <header className="home-header">
    ...
    <ExternalLink className="button primary" to="https://docs.google.com/forms/d/e/1FAIpQLSc42Nvv4n8X80YckrCSUzKZphsVoKCqXkeHNgIeSjMKTjcdUA/viewform?usp=sf_link">Zaproponuj slogan</ExternalLink>
    <div className="sm">
